...
# SPEEDUP_BENCH_ALGORITHM_NAME="gol-cuda-simple-warp-ex-full-adder-rows-32"
...
VALIDATION_ALGORITHM_NAME="gol-cuda-naive-bitwise-cols-64"
...
srun -p gpu-short -A kdss --cpus-per-task=64 --mem=64GB --gres=gpu:H100 --time=2:00:00 $GOL_EXE_NAME \
    ...
    --use-contracted-diff="$USE_CONTRACTED_DIFF" \
