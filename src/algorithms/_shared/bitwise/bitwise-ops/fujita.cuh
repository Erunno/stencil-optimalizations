#ifndef ALGORITHMS_FUJITA_IMPL
#define ALGORITHMS_FUJITA_IMPL
...
struct FujitaImplantation {
    ...
    static __host__ __device__ __forceinline__ word_type compute_center_word_fujita(
